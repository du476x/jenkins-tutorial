...
#CA key generation
openssl genrsa -des3 -out ./ca/$CA_NAME.key -passout pass:$PASSWORD 2048
#CA Root certificate
openssl req -x509 -new -nodes -key $CA_NAME.key -sha256 -days 1825 -subj "/C=$COUNTRY/ST=$STATE/L=$LOCALITY/O=$ORGANIZATION/OU=$ORG_UNIT/CN=$COMMON_NAME" -passin pass:$PASSWORD -out ./ca/$CA_NAME.pem
